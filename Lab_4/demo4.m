...
printf("The ergodic Probability of P(0) = %f%%\n", 100 * P(1))
printf("The ergodic Probability P(1) = %f%%\n", 100 * P(2))
printf("The ergodic Probability P(2) = %f%%\n", 100 * P(3))
printf("The ergodic Probability P(3)/Rejection = %f%%\n", 100 * P(4))
